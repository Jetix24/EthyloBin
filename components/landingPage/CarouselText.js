    ...
    <section className="max-w-5xl  max-h-5xl mx-auto flex flex-col items-center justify-center gap-16 lg:gap-20 px-8 py-2 lg:py-5">
      <div className="carousel max-w-6xl rounded-md">
        <div id="slide1" className="carousel-item relative w-full h-full">
          ...
          <p className="mt-2 text-[2.5vw] md:mt-4 md:text-xl font-medium text-gray_200/90">Una interfaz intuitiva que no requiere conocimientos técnicos.</p>
          </div>
        </div>
        <div id="slide2" className="carousel-item relative w-full">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-1/3 md:h-1/4 flex items-center justify-center flex-col" style={{backgroundColor: 'rgba(12, 8, 31, 0.7)'}}>
            ...
            <p className="mt-2  text-[2.5vw] md:mt-4 md:text-xl  font-medium text-gray_200/90">Actualizaciones en tiempo real al utilizar los productos.</p>
          </div>
        </div> 
        <div id="slide3" className="carousel-item relative w-full">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-1/3 md:h-1/4 flex items-center justify-center  flex-col " style={{backgroundColor: 'rgba(12, 8, 31, 0.7)'}}>
            ...
            <p  className="mt-2 text-[2.5vw] md:mt-4 md:text-xl   font-medium text-gray_200/90"> Gestiona tu inventario por areas dentro del almacén.</p>
          </div>
        </div> 
        <div id="slide4" className="carousel-item relative w-full">
          ...
          <div className="absolute bottom-0 left-0 right-0 h-1/3 md:h-1/4 flex items-center justify-center  flex-col " style={{backgroundColor: 'rgba(12, 8, 31, 0.7)'}}>
            ...
            <p  className="mt-2  text-[2.5vw] md:mt-4 md:text-xl   font-medium text-gray_200/90">Registra tus proveedores y relacionalos con tus productos.</p>
          </div>
        </div>
      </div>
    </section>
