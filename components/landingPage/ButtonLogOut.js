...
const ButtonLogOut = () => {
  ...
  if (status === "authenticated") {
    return (
      <button
        className={`btn text-lg md:text-xl bg-blue_200 btn-block text-purple_200 rounded-lg border-0 hover:bg-blue_100 group sm:ml-4 ${active && 'bg-emerald-500 text-gray-100'} sm:w-10`}
