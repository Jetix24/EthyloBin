...
const Testimonial = ({ i }) => {
  ...
  return (
    <li key={i}>
      <figure className="relative h-full p-6 bg-base-100 rounded-md">
...
const VideoTestimonial = ({ i }) => {
  ...
  return (
    <li
      key={i}
      className="break-inside-avoid max-md:flex justify-center bg-base-100 rounded-md overflow-hidden flex flex-col"
    >
