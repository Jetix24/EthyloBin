    ...
    <>
      <section className="text-center max-w-xl mx-auto mt-12 mb-24 md:mb-32">
        ...
        <p className="text-lg opacity-80 leading-relaxed">
          Descubre las mejores prácticas, consejos y tendencias en gestión de
          inventarios para cafeterías y pequeños restaurantes. ¡Explora nuestros
          artículos y lleva tu café al siguiente nivel con Tario!
        </p>
      </section>
