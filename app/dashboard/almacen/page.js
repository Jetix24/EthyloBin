    ...
    <div className="pl-5">
      <div className="p-5 h-full">
        ...
        <div className="flex flex-col lg:flex-row items-center">
          ...
          <div className="radial-progress mb-10" style={{ "--value": etileno || 131, "--size": "20rem", "--thickness": "2rem", "fontSize": "3rem" }} role="progressbar">
            {etileno !== null ? `${etileno} mg/m3` : '131 mg/m3'}
          </div>
